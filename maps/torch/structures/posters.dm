...
/singleton/poster/torch/event2
	...
	desc = "A poster loudly advertising the Dauntless's captain's upcoming bid for SCG Senate. The fine print lightly suggests that failing to vote in their favor will result in an NJP."
