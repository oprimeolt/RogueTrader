...
<p><tt><tt><strong>FROM:</strong> Admiral Henry Lau, Observatory<br /><strong>TO:</strong> Expeditionary Corps Vessel #3, Dauntless<br /><strong>CC:</strong> Flag Admiral Magny Khan, Commandant of the Expeditionary Corps<br /><strong>SUBJECT:</strong> Update to the Dauntless<br /></tt></tt></p>
<hr />
